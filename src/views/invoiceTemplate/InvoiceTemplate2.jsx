...
const InvoiceTemplate2 = () => {
    return (
        <Grid>
            ...
            <Grid.Column width={8} verticalAlign="middle" className="tempInvoiceDetails">
            ...
            <Grid.Column width={8}>
                <Header as="h3" className="detailCaptions">Payable To :</Header>
            ...
            <Grid.Column width={8}>
                <Header as="h3" className="detailCaptions">Bill To :</Header>
